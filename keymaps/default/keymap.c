...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        ...
        LT(_FUNCTION, KC_TAB), LT(_SYMBOLS_RIGHT, KC_SPACE), LT(_NAV, KC_DELETE),        LT(_NUMPAD, KC_ENTER), LT(_SYMBOLS_LEFT, KC_BACKSPACE), LT(_FUNCTION, KC_ESCAPE)
    ),

    [_SYMBOLS_RIGHT] = LAYOUT(
                 _______, _______, _______, _______, _______,               KC_PIPE, KC_LBRC, KC_RBRC, KC_GRAVE, _______,
                 KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, _______,               KC_HASH, KC_LPRN, KC_RPRN, KC_EXCLAIM, KC_QUESTION,
        _______, _______, _______, _______, _______, _______,               KC_AT, KC_LCBR, KC_RCBR, KC_DOLLAR, RALT(KC_E), _______,
                                   _______, _______, _______,               _______, _______, _______
    ),

    [_SYMBOLS_LEFT] = LAYOUT(
                 KC_BACKSLASH, KC_LT, KC_GT, KC_MINUS, KC_PERCENT,          _______, _______, _______, _______, _______,
                 KC_ASTERISK, KC_PLUS, KC_SLASH, KC_EQUAL, KC_AMPERSAND,    _______, KC_RSFT, KC_LCTL, KC_LALT, KC_LGUI,
        _______, KC_CIRC, KC_TILDE, CURR_DIR, UP_DIR, HOME_DIR,             _______, _______, _______, _______, _______, _______,
                                     _______, _______, _______,             _______, _______, _______
    ),
