...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SYMBOLS] = LAYOUT(
                 KC_ASTERISK, KC_LT, KC_GT, KC_BACKSLASH, KC_PERCENT,                                        KC_PIPE, KC_LBRC, KC_RBRC, KC_GRAVE, _______,
                 LGUI_T(KC_MINUS), LALT_T(KC_PLUS), LCTL_T(KC_SLASH), LSFT_T(KC_EQUAL), KC_AMPERSAND,        KC_HASH, RSFT_T(KC_LPRN), LCTL_T(KC_RPRN), LALT_T(KC_EXCLAIM), LGUI_T(KC_QUESTION),
